...
local captureLootSlots = FieldJournal.Bestiary.captureLootSlots
local clearLootSlots = FieldJournal.Bestiary.clearLootSlots
local commitLootSlot = FieldJournal.Bestiary.commitLootSlot
local observeUnit = FieldJournal.Bestiary.observeUnit
local partyKill = FieldJournal.Bestiary.partyKill
local unitDied = FieldJournal.Bestiary.unitDied
